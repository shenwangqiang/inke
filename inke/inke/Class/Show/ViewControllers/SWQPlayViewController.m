//
//  SWQPlayViewController.m
//  inke
//
//  Created by 沈王强 on 2017/8/18.
...
@interface SWQPlayViewController ()
...
@implementation SWQPlayViewController
...
- (void)initPlayer {
    ...
    self.player = [[IJKFFMoviePlayerController alloc] initWithContentURL:[NSURL URLWithString:self.live.url] withOptions:options];
...
- (void)initBlurImage {
    ...
    [imageView downloadImage:[NSString stringWithFormat:@"%@%@",IMAGE_HOST, self.live.room_src] placeholder:@"default_room"];
